...
<body>
<h2>Editing</h2>
<h3><a href="/playersPage">Go back</a></h3>
<form:form method="post" modelAttribute="player" action="/playersPage">
    <ul>
        ...
        <label><spring:message code="players.team.name"/><form:input path="teamName" type="text"/></label>
